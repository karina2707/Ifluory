        ...
        static List<Company> ReadDataExcelFileDOM(string fileName)
        {
            ...
            using (SpreadsheetDocument spreadsheetDocument = SpreadsheetDocument.Open(fileName, false))
            {
                ...
                foreach (Row row in sheetData.Elements<Row>())
                {
                    ...
                    string row1 = rowData[varst0].CellValue.Text;
                    string row46 = rowData[varst46].CellValue.Text;
                    string row4 = rowData[varst4].CellValue.Text;
                    string row59 = rowData[varst59].CellValue.Text;
